...
const Home = ({ largeBlogs, smallBlogs, mediumBlogs }) => {
  ...
  function HeaderSEO(){
     return <Head>
                ...
                <meta property="og:title" content={`This site is a knowledge website based on our ancient medicinal knowledge to cure various diseases. All the medicinal herbs and their uses in different diseases. Herbs can be searched by diseases name and vice versa. | ${process.env.NEXT_PUBLIC_APP_NAME}`} />
                <meta
                ...
                <meta property="og:image" content={`${process.env.NEXT_PUBLIC_DOMAIN_URL}/vedifly.svg`} />
                <meta property="og:image:secure_url" content={`${process.env.NEXT_PUBLIC_DOMAIN_URL}/vedifly.svg`} />
